...
export default function TifoSpotlight({ tifo = defaultTifo }: TifoSpotlightProps) {
  ...
  return (
    <motion.div
      ...
      className="relative"
    >
      <Card className="overflow-hidden border-2 border-red-500/30 bg-gradient-to-br from-red-500/10 to-zinc-900">
        {/* Badge */}
        <div className="absolute top-4 left-4 z-20 flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-600 text-white text-sm font-bold">
        ...
        <CardContent className="p-6">
          ...
          <p className="text-red-500 font-medium mb-4">{tifo.group} - {tifo.club}</p>
